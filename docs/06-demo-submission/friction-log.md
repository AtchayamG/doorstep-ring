...
* **Workaround**: Keep the currently published demo on explicitly labelled fixtures. Browser-generated WHEP session negotiation returned 201. A separate `werift` capture-client offer returned **HTTP 500** on 2026-09-23 after device discovery returned 200. No video RTP or frame was received. The difference between the offers has not yet been diagnosed; neither Ring service failure nor client incompatibility is established.
